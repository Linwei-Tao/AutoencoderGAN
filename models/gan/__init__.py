...
def get_architecture(architecture, image_size, P=None):
    ...
    elif architecture == 'diffAug-stylegan':
        from models.gan.diffAug_stylegan import Generator
        from models.gan.diffAug_stylegan import Discriminator
        resolution = image_size[0]
        generator = Generator(size=resolution, n_mlp=8, small32=True)
        discriminator = Discriminator(img_resolution=resolution, small32=True,
                                               mlp_linear=True, d_hidden=512)
