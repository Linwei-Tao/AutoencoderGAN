...
# only take one real view and one generated view, the same the debiased_contrad_v2,
...
def loss_D_fn(P, D, options, images, gen_images):
    ...
    dcd_loss = DCD_loss_v3(real1, real2, fake1, fake2, temperature=P.temp, params=P, distributed=P.distributed)
